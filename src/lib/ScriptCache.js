...
// Import the window global first
const windowGlobal = require('./windowOrGlobal');

// Then use it consistently throughout
let scriptMap = typeof windowGlobal !== 'undefined' && windowGlobal._scriptMap || new Map();
...
export const ScriptCache = (function(global) {
    ...
    return function ScriptCache(scripts) {
            ...
            if (!scriptMap.has(key)) {
                ...
                let promise = new Promise((resolve, reject) => {
                    ...
                    if (src.match(/callback=CALLBACK_NAME/)) {
                        ...
                        cb = windowGlobal[cbName] = tag.onload;
                    } else {
        ...
        Object.keys(scripts).forEach(function(key) {
            ...
            const tag = windowGlobal._scriptMap.has(key) ?
                        windowGlobal._scriptMap.get(key).tag :
